...
#/usr/bin/restic backup -o s3.storage-class=INTELLIGENT_TIERING --exclude-file=/home/iboaz/excludes.txt --one-file-system --verbose / /mnt/samsung/copypart /mnt/samsung/media/navidrome
/usr/bin/restic -r /mnt/usb/backups/ unlock
/usr/bin/restic -r /mnt/usb/backups/ backup --exclude-file=/home/iboaz/excludes.txt --one-file-system --verbose --json / /mnt/samsung/copyparty /mnt/samsung/media/navidrome | python3 /home/iboaz/backup_log.py "USB"
/usr/bin/restic -r b2:debian-homelab-backups:/  unlock
/usr/bin/restic -r b2:debian-homelab-backups:/  backup --exclude-file=/home/iboaz/excludes.txt --one-file-system --verbose --json / /mnt/samsung/copyparty /mnt/samsung/media/navidrome | python3 /home/iboaz/backup_log.py "Backblaze"
